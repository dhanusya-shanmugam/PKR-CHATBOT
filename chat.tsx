...
export default function Chat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: `Hi! Welcome to PKR 👋

I'm Noah — your PKR Arts College assistant.
Ask me about departments, admissions, fees, hostel, library, placement, timings, and more.
You can type in English or தமிழ். Tap the mic to speak.`,
      sender: "bot",
    }
  ]);
